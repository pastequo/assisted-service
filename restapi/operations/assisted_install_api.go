...
func NewAssistedInstallAPI(spec *loads.Document) *AssistedInstallAPI {
	return &AssistedInstallAPI{
		...
		InstallerGetFeatureSupportsHandler: installer.GetFeatureSupportsHandlerFunc(func(params installer.GetFeatureSupportsParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation installer.GetFeatureSupports has not yet been implemented")
		}),
...
type AssistedInstallAPI struct {
	...
	// InstallerGetFeatureSupportsHandler sets the operation handler for the get feature supports operation
	InstallerGetFeatureSupportsHandler installer.GetFeatureSupportsHandler
...
func (o *AssistedInstallAPI) Validate() error {
	...
	if o.InstallerGetFeatureSupportsHandler == nil {
		unregistered = append(unregistered, "installer.GetFeatureSupportsHandler")
	}
...
func (o *AssistedInstallAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/v2/support-levels/feature-supports"] = installer.NewGetFeatureSupports(o.context, o.InstallerGetFeatureSupportsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
